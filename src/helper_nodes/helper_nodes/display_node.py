...
class DisplayNode(Node):
    """
    Displays annotated video frames in real-time OpenCV window.
    Overlays company logo and shows inference results visually.
    """
    def __init__(self):
    ...
    def listener_callback(self, msg):
        try:
            ...
            cv2.imshow("YOLOv5 Annotated View", frame)
            cv2.waitKey(1)
        except Exception as e:
